...
export const GlareCard = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  ...
  return (
    <div
      ...
      className="relative isolate h-fit [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform md:h-[260px] w-full [aspect-ratio:17/21]"
      ref={refElement}
      onPointerMove={(event) => {
